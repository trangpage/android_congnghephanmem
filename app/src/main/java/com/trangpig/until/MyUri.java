...
public class MyUri {
    ...
    public static final String URL_DOWN_IMAGE = "http://%s:8080/tuyensinh/image?filename=%s";    public static final String URL_GET_ACCOUNT = "http://%s:8080/tuyensinh/getacc/%s";    public static final String URL_GET_LIST_ADD_FRIEND = "http://%s:8080/tuyensinh/getlistaddfriend?idAcc=%s";
